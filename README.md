...
Unity 6 · C# · xLua · FairyGUI · **393 tests**: 238 engine-free core tests that run under `dotnet test` in
CI *and* again inside Unity, plus 116 Unity-only EditMode tests and 39 PlayMode tests.
...
the suites would count them twice, so the honest total is 393 distinct tests. `docs/STATUS.md` shows the
set arithmetic.
